...
import { useCreateBoard } from "../../hooks/useBoards.js";

/**
 * CreateBoardModal
 *
 * Form: title → useMutation → invalidates cache → closes
 *
 * Props:
 *   isOpen: boolean
 *   onClose: function
        ...
        >
            <div className="w-full max-w-md mx-4 bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl shadow-black/40 overflow-hidden">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800/60">
                    <h2 className="text-[15px] font-bold text-white">Create Board</h2>
                    <button
                        onClick={onClose}
