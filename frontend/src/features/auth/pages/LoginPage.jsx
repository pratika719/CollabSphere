    ...
    return (
        <div className="space-y-6">
            ...
            {(validationError || isError) && (
                <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30 text-red-400 text-sm flex items-start space-x-2 animate-shake">
                    ...
                    <span className="text-left font-medium">
                        {validationError || error?.response?.data?.message || "Login failed. Please check your credentials."}
                    </span>
                </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                    <div className="flex justify-between items-center">
                        ...
                        <a href="#" className="text-xs text-purple-400 hover:text-purple-300 hover:underline transition">
                            Forgot password?
                        </a>
                    </div>
                    <input
            ...
            <div className="pt-2 border-t border-slate-800/80 text-center text-sm text-slate-400">
                ...
                <Link to="/register" className="font-semibold text-purple-400 hover:text-purple-300 hover:underline transition">
                    Create one here
                </Link>
            </div>
        </div>
